...
def toggle_full_screen(screen):
    """Move to full screen at the start of game."""
    w, h = screen.get_width(), screen.get_height()
    flags = screen.get_flags()
    bits = screen.get_bitsize()
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    ...
    # Redraw all bullets behind ship and aliens only if game is active.
    ...
    # group.draw() looks for a function containing blit()
    # And calls it for each sprite in the group
    aliens.draw(screen)
